...
export default function FrontDiffernce() {
    return ( 
        <FrontDifferenceContainer>
            <TextContainer>
                ...
                <ul>
                    <li>
                        <p>Performance, Don't lose anymore customers due to slow page loading times</p>
                    </li>
                    <li>
                        <p>Responsive Mobile First Design, Consistent web experience across all devices</p>
                    </li>
                    <li>
                        <p>Engagement, get more from your web visitors</p>
                    </li>
                </ul>
            </TextContainer>
        </FrontDifferenceContainer>
